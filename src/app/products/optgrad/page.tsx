...
import { GraduationCap, Map, Target, Users, CheckCircle } from "lucide-react";
...
export default function OptGradPage() {
  return (
    <>
      <Header />
      <main style={{ background: "var(--primary-bg)", minHeight: "100vh" }}>
            ...
            <div className={styles.grid} style={{ gap: "32px" }}>
              {[
                { 
                  ...
                  desc: "Generate custom learning paths based on your current skills and target career goals with AI-driven gap analysis." 
                },
                { 
                  icon: Target, 
                  title: "Focused Upskilling", 
                  desc: "Dynamic content delivery optimized for your learning style and pace to maximize information retention." 
                },
                { 
                  icon: Users, 
                  title: "Skill Certification", 
                  desc: "Earn valid credentials and prove your expertise through AI-proctored assessments and project-based validation." 
                }
              ].map((item, i) => (
            ...
            <div style={{ marginTop: "120px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "40px", alignItems: "center" }}>
                <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                  {[
                    "AI-driven mentor support & 24/7 tutoring.",
                    "Integration with enterprise learning systems (LMS).",
                    "Real-time progress tracking & skill heatmaps.",
                    "Direct talent-to-opportunity mapping."
                  ].map((label, i) => (
                ...
                <div style={{ padding: "48px", background: "var(--secondary-bg)", borderRadius: "24px", border: "1px solid var(--border)" }}>
                   <p style={{ fontSize: "24px", color: "var(--text-muted)", fontStyle: "italic", lineHeight: 1.5 }}>
                     &quot;OptGrad democratizes access to high-tier education, ensuring every learner has a direct, optimized path to their future.&quot;
                   </p>
                </div>
              </div>
            </div>
        ...
        <section className={styles.section} style={{ background: "var(--secondary-bg)", borderTop: "1px solid var(--border)", marginTop: "100px" }}>
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={STAGGER} style={{ textAlign: "center", maxWidth: "800px", margin: "0 auto" }}>
              <motion.h2 variants={FADE_UP} style={{ fontSize: "42px", marginBottom: "24px" }}>Start Your Journey.</motion.h2>
              <motion.p variants={FADE_UP} style={{ color: "var(--text-muted)", marginBottom: "40px", fontSize: "18px" }}>
                Build your personalized AI learning roadmap today and accelerate your career.
              </motion.p>
